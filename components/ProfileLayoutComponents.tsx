// Layout компоненты для профиля пользователя
...
export function MiniStripeLogo() {
  return (
    <div className="absolute h-[10px] sm:h-[12px] md:h-[13px] left-1/2 transform -translate-x-1/2 top-[50px] w-[80px] sm:w-[100px] md:w-32" data-name="Mini_stripe_logo">
