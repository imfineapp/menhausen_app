...
function CardInfo({ cardTitle, formattedDate }: { cardTitle: string; formattedDate: string }) {
  return (
    <div
      ...
      data-name="Card Info"
    >
      <div className="font-['Roboto Slab',_'Georgia',_'Times_New_Roman',_serif] font-normal leading-[0] relative shrink-0 text-[#e1ff00] text-left w-full">
    ...
    >
      ...
      <div className="flex flex-row items-center justify-center relative size-full">
        <div className={`box-border content-stretch flex flex-row gap-2.5 items-center justify-center p-[20px] relative w-full`} style={{ minHeight: `${height}px` }}>
          <div className="font-['PT Sans',_'Helvetica_Neue',_'Arial',_sans-serif] font-bold leading-[0] not-italic relative shrink-0 text-[#cfcfcf] text-[18px] sm:text-[19px] md:text-[20px] text-left w-full">
...
function MainContent({ checkinData }: { checkinData: CheckinData }) {
  return (
    <div className="box-border content-stretch flex flex-col gap-[30px] items-start justify-start p-0 relative shrink-0 w-full">
      {/* Первый вопрос */}
      <div className="font-['PT Sans',_'Helvetica_Neue',_'Arial',_sans-serif] font-bold leading-[0] not-italic relative shrink-0 text-[#e1ff00] text-[18px] sm:text-[19px] md:text-[20px] text-left w-full">
      ...
      <div className="font-['PT Sans',_'Helvetica_Neue',_'Arial',_sans-serif] font-bold leading-[0] not-italic relative shrink-0 text-[#ffffff] text-[18px] sm:text-[19px] md:text-[20px] text-left w-full">
