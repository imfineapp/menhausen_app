...
interface DeleteAccountScreenProps {
  onBack: () => void;
  onDeleteAccount: () => void | Promise<void | { serverDeleted: boolean }>;
}
  ...
  const handleDelete = async () => {
    try {
      ...
      const serverDeleted =
        ...
        'serverDeleted' in result &&
        (result as { serverDeleted: boolean }).serverDeleted === true;

      alert(serverDeleted ? successMessage : serverDeleteFailedMessage);
