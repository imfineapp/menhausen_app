...
function PlanInfo() {
  return (
    <div
      ...
      data-name="Plan Info"
    >
      <div className="font-sans not-italic relative shrink-0 text-[#ffffff] text-[20px] text-nowrap">
        <p className="block leading-none whitespace-pre">Your current plan</p>
      </div>
      <div
        className="font-heading font-normal min-w-full relative shrink-0 text-[#e1ff00] text-[24px]"
