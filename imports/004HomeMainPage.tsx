...
function InfoGroup() {
  return (
    ...
    >
      <div className="font-['Roboto_Slab:Regular',_sans-serif] font-normal leading-[0] relative shrink-0 text-[#2d2b2b] text-[24px] text-left text-nowrap">
...
function InfoContainer() {
  return (
    ...
    >
      <InfoGroup />
      <div className="font-['PT_Sans:Regular',_sans-serif] leading-[0] not-italic relative shrink-0 text-[#2d2b2b] text-[20px] text-left w-full">
...
function ProgressTheme3() {
  return (
    <div className="h-6 relative shrink-0 w-[351px]" data-name="Progress_theme">
      ...
      <div className="absolute font-['PT_Sans:Bold',_sans-serif] inset-[12.5%_4.56%_20.83%_4.56%] leading-[0] not-italic text-[#696969] text-[16px] text-left">
        <p className="block leading-none">Progress</p>
      </div>
    </div>
  );
...
function CardAnonsStatus() {
  return (
    ...
    >
      <div className="font-['PT_Sans:Bold',_sans-serif] leading-[0] not-italic relative shrink-0 text-[#e1ff00] text-[15px] text-center tracking-[-0.43px] w-[66px]">
...
function Frame27() {
  return (
    <div className="box-border content-stretch flex flex-col gap-5 items-start justify-start p-0 relative shrink-0 w-[249px]">
      ...
      <div
        className="font-['PT_Sans:Regular',_sans-serif] leading-[0] min-w-full not-italic relative shrink-0 text-[#333333] text-[20px] text-left"
        style={{ width: "min-content" }}
      >
        <p className="block leading-none">{`Check in with yourself — it's the first step to self-care! Do it everyday.`}</p>
      </div>
...
function Frame42() {
  return (
    <div className="absolute box-border content-stretch flex flex-row gap-[13px] inset-[17.81%_7.83%_16.44%_7.83%] items-center justify-start p-0">
      <SocialIcons />
      <div className="font-['Roboto_Slab:Regular',_sans-serif] font-normal leading-[0] relative shrink-0 text-[#2d2b2b] text-[24px] text-nowrap text-right">
