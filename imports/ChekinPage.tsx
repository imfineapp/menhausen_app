...
function CardInfo() {
  return (
    <div
      ...
      data-name="Card Info"
    >
      <div className="font-heading font-normal leading-[0] relative shrink-0 text-[#e1ff00] text-[0px] text-left w-full">
...
function Frame49() {
  return (
    <div className="box-border content-stretch flex flex-col gap-[30px] items-start justify-start p-0 relative shrink-0 w-full">
      <div className="font-sans h-11 leading-[0] not-italic relative shrink-0 text-[#e1ff00] text-[20px] text-left w-full">
      ...
      <InputAnswerBlock1 />
      <div className="font-sans font-bold leading-[0] not-italic relative shrink-0 text-[#ffffff] text-[0px] text-left w-full">
