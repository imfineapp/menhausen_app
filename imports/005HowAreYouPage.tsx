import svgPaths from "./svg-xgh5f6h0jm";
...
function MoodPrograssbar() {
  return (
    <div className="absolute bg-[#2d2b2b] inset-[56.1%_10.43%_40.38%_10.43%] rounded-xl" data-name="Mood_prograssbar">
...
function ImFeelingDown() {
  return (
    <div className="absolute h-[26px] left-[22px] top-[412px] w-[348px]" data-name="I\'m feeling down...">
...
function Container() {
  return (
    <div className="absolute contents left-[22px] top-[412px]" data-name="Container">
      <MoodPrograssbar />
      <ImFeelingDown />
    </div>
  );
...
function Container1() {
  return (
    <div className="absolute contents left-5 top-[189px]" data-name="Container">
      <HeroBlockQuestion />
      <Container />
    </div>
  );
...
export default function Component005HowAreYouPage() {
  return (
    <div className="bg-[#111111] relative size-full" data-name="005_how are you page">
      <Light />
      <Button />
      <Container1 />
      <HeaderBlock />
