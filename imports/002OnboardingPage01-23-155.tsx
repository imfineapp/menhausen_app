import svgPaths from "./svg-nt7wuddmjy";
...
function ButtonBlock() {
  return (
    <div
      className="absolute box-border content-stretch flex flex-col gap-10 items-center justify-start left-[21px] p-0 top-[688px] w-[351px]"
    ...
    >
      <div className="font-sans font-bold leading-[0] not-italic relative shrink-0 text-[#ffffff] text-[0px] text-center w-full">
        <p className="leading-none text-[14px]">
          ...
          <span className="[text-decoration-line:underline] [text-decoration-style:solid] [text-underline-position:from-font] font-sans not-italic">
            Terms of use
          </span>
          <span className="font-sans not-italic">{` and`}</span>
          <span className="[text-decoration-line:underline] [text-decoration-style:solid] [text-underline-position:from-font] font-sans not-italic">{` Privacy policy`}</span>
        </p>
      </div>
      <Button />
    </div>
