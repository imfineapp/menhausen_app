import svgPaths from "./svg-3cs3yu7qqd";
...
function Checkin() {
  return (
    <div className="h-[60px] relative shrink-0 w-[351px]" data-name="Checkin">
...
function CheckinsList() {
  return (
    <div
      className="[grid-area:1_/_1] box-border content-stretch flex flex-col gap-2.5 items-start justify-start ml-0 mt-[39px] p-0 relative w-[351px]"
...
function CheckinsContainer() {
  return (
    <div
      className="grid-cols-[max-content] grid-rows-[max-content] inline-grid place-items-start relative shrink-0"
      data-name="Checkins Container"
    >
      <div className="[grid-area:1_/_1] font-heading font-normal leading-[0] ml-0 mt-0 relative text-[#e1ff00] text-[24px] text-left w-[351px]">
...
function CardContainer() {
  return (
    <div
      className="absolute box-border content-stretch flex flex-col gap-10 items-start justify-start leading-[0] left-[21px] p-0 top-[141px] w-[351px]"
...
export default function CardOpenedOncePage() {
  return (
    <div className="bg-[#111111] relative size-full" data-name="Card opened once page">
      <Light />
      <CardContainer />
      <ButtonCutOffBlock />
      <MiniStripeLogo />
