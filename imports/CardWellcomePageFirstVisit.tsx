import svgPaths from "./svg-rwub9knk7s";
...
export default function CardWellcomePageFirstVisit() {
  return (
    <div className="bg-[#111111] relative size-full" data-name="Card Wellcome Page (first visit)">
      <Light />
      <Button />
      <div className="absolute font-['PT_Sans:Regular',_sans-serif] h-[89px] leading-[0] left-[196.5px] not-italic text-[#ffffff] text-[20px] text-center top-[337px] translate-x-[-50%] w-[351px]">
