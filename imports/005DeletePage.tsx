import svgPaths from "./svg-tf9lg82y07";
...
function ButtonBlock() {
  return (
    ...
    >
      <div className="font-sans font-bold leading-[0] not-italic relative shrink-0 text-[#e1ff00] text-[14px] text-center w-full">
...
function MainContent() {
  return (
    <div
      className="absolute box-border content-stretch flex flex-col gap-10 items-start justify-start leading-[0] left-[19px] p-0 text-center top-[437px] w-[351px]"
...
export default function Component005DeletePage() {
  return (
    <div className="bg-[#111111] relative size-full" data-name="005_delete page">
      <Light />
      <ButtonBlock />
      <MainContent />
      <HeaderBlock />
