import svgPaths from "./svg-e41m9aecp1";
  ...
  return (
    ...
    >
      ...
      <div className="font-['PT_Sans:Regular',_sans-serif] not-italic relative shrink-0 text-[#ffffff] text-[14px] text-left w-full">
        ...
        <p className="block leading-none mb-0">&nbsp;</p>
        <p className="block leading-none mb-0">1. No Personally Identifiable Information (PII)</p>
        <p className="block leading-none mb-0">
          We designed Menhausen with anonymity as a core value.
          <br aria-hidden="true" />{" "}
        </p>
        <p className="block leading-none mb-0">
          By default, we do not collect or store any personally identifiable information (PII) such as your name, email
          address, phone number, or IP address.
        </p>
        <ul className="css-ed5n1g list-disc mb-0">
          <li className="mb-0 ms-[21px]">
            <span className="leading-none">No sign-up is required to use the Service.</span>
          </li>
          <li className="mb-0 ms-[21px]">
        ...
        <p className="block leading-none mb-0">&nbsp;</p>
        <p className="block leading-none mb-0">2. Data We May Collect (Anonymous Only)</p>
        <p className="block leading-none mb-0">
          To improve your experience and app functionality, we may collect and process the following non-personal and
          aggregated information:
        </p>
        <p className="block leading-none mb-0">
          Type of DataPurposeAnonymous interaction history (e.g., which cards you’ve opened)To tailor recommendations
          and UXMood check-in data (non-identifying)To show trends and generate insightsSession events (e.g., clicks,
          duration)For app optimization and bug fixingDevice/browser typeFor UI compatibilityEncrypted TON wallet
          address (if connected)To issue on-chain tokens or rewards (optional)
        </p>
        <p className="block leading-none mb-0">
          All such data is collected without linkage to any identity and is stored securely using industry standards.
        </p>
        <p className="block leading-none mb-0">&nbsp;</p>
        <p className="block leading-none mb-0">3. Telegram Integration</p>
        <p className="block leading-none mb-0">
        ...
        <ul className="css-ed5n1g list-disc mb-0">
          ...
          <li className="ms-[21px]">
            <span className="leading-none">We do not access your Telegram messages, contacts, or phone number.</span>
          </li>
        </ul>
        <p className="block leading-none mb-0">&nbsp;</p>
        <p className="block leading-none mb-0">4. Crypto Payments and Web3</p>
        <p className="block leading-none mb-0">
        ...
        <ul className="css-ed5n1g list-disc mb-0">
          ...
          <li className="mb-0 ms-[21px]">
            <span className="leading-none">We do not store private keys, wallet balances, or transaction logs.</span>
          </li>
          <li className="ms-[21px]">
            <span className="leading-none">
        ...
        <p className="block leading-none mb-0">&nbsp;</p>
        <p className="block leading-none mb-0">{`5. Cookies & Analytics`}</p>
        <p className="block leading-none mb-0">
        ...
        <p className="block leading-none mb-0">&nbsp;</p>
        <p className="block leading-none mb-0">6. Data Security</p>
        <p className="block leading-none mb-0">
        ...
        <p className="block leading-none mb-0">&nbsp;</p>
        <p className="block leading-none mb-0">7. Your Rights</p>
        <p className="block leading-none mb-0">You may request to:</p>
        <ul className="css-ed5n1g list-disc mb-0">
          <li className="mb-0 ms-[21px]">
            <span className="leading-none">Access the anonymous data associated with your session token;</span>
          </li>
          <li className="mb-0 ms-[21px]">
            <span className="leading-none">Delete all local usage data (via app settings or upon request);</span>
          </li>
          <li className="ms-[21px]">
            <span className="leading-none">Opt out of future tracking or analytics.</span>
          </li>
        </ul>
        <p className="block leading-none mb-0">
        ...
        <p className="block leading-none mb-0">&nbsp;</p>
        <p className="block leading-none mb-0">8. Changes to This Policy</p>
        <p className="block leading-none mb-0">
          We reserve the right to update this Privacy Policy at any time. Any changes will be posted within the
          application and on our official website.
          <br aria-hidden="true" />
          {` If material changes are made, we will notify users via the app interface or Telegram announcement.`}
        </p>
        <p className="block leading-none mb-0">&nbsp;</p>
        <p className="block leading-none mb-0">9. Contact Us</p>
        <p className="block leading-none mb-0">
...
export default function Component002PrivacyPolicy() {
  return (
    <div className="bg-[#111111] relative size-full" data-name="002_privacy policy">
      <Light />
      <MainContent />
      <HeaderBlock />
    </div>
